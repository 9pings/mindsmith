'use strict';
/**
 * skynet-dequantizer — the LOCAL APPLIANCE, a thin assembly over the skynet-graph engine:
 *
 ...
 *
 * `createApp` takes injectable backends (tests run it with stubs, GPU-free); bin/skynet-dequantizer
