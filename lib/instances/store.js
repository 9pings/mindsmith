 ...
 * last `revisionsTail` rows with an honest `compactedBelow` marker. The HOT graph is bounded by
...
function createStore( opts ) {
	...
	const revisionsTail = opts.revisionsTail == null ? 200 : opts.revisionsTail;
