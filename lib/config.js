 ...
 *     "defaults":  { "model": "local", "escalation": "frontier", "local": "local", "maxTokens": 2048 },
 *       // defaults.maxTokens (owner 07-21) : le budget de complétion par défaut quand l'appelant n'en
 *       // passe pas — built-in 2048 (= le défaut llm-local 1024 DOUBLÉ ; les contenus peuvent justifier
 *       // plus). SET → le même knob gouverne aussi les budgets par-path des tools (sinon : tools 600).
